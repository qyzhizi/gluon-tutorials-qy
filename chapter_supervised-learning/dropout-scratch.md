...
mask = nd.random.uniform(#uniform 均匀分布 0到1 之间
        0, 1.0, X.shape, ctx=X.context) < keep_probability 每个元素和keep_probability比较，为真则为1 为假则为0
mask1=nd.arange(20).reshape((5,4))
mask1=mask1<6
print(mask1)
```
