...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "Downloading /home/qy/.mxnet/datasets/fashion-mnist/train-images-idx3-ubyte.gz from https://apache-mxnet.s3-accelerate.dualstack.amazonaws.com/gluon/dataset/fashion-mnist/train-images-idx3-ubyte.gz...\nDownloading /home/qy/.mxnet/datasets/fashion-mnist/train-labels-idx1-ubyte.gz from https://apache-mxnet.s3-accelerate.dualstack.amazonaws.com/gluon/dataset/fashion-mnist/train-labels-idx1-ubyte.gz...\nDownloading /home/qy/.mxnet/datasets/fashion-mnist/t10k-images-idx3-ubyte.gz from https://apache-mxnet.s3-accelerate.dualstack.amazonaws.com/gluon/dataset/fashion-mnist/t10k-images-idx3-ubyte.gz...\nDownloading /home/qy/.mxnet/datasets/fashion-mnist/t10k-labels-idx1-ubyte.gz from https://apache-mxnet.s3-accelerate.dualstack.amazonaws.com/gluon/dataset/fashion-mnist/t10k-labels-idx1-ubyte.gz...\n"
 }
]
```
...
我们需要定义一个针对预测为概率值的损失函数。其中最常见的是交叉熵损失函数，它将两个概率分布的`负交叉熵`作为目标值，最小化这个值等价于最大化这两个概率的相似度。
...
```{.python .input  n=12}
def cross_entropy(yhat, y): #yhat 是预测值
    return - nd.pick(nd.log(yhat), y) #对yhat进行log操作，从中选出第y个数据
```
...
[
 {
  "data": {
   "text/plain": "0.098046875000000006"
  },
  "execution_count": 16,
  "metadata": {},
  "output_type": "execute_result"
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "Epoch 0. Loss: 3.503660, Train acc 0.457042, Test acc 0.596191\nEpoch 1. Loss: 1.841446, Train acc 0.636691, Test acc 0.670410\nEpoch 2. Loss: 1.533874, Train acc 0.682923, Test acc 0.694629\nEpoch 3. Loss: 1.377014, Train acc 0.707569, Test acc 0.714258\nEpoch 4. Loss: 1.274989, Train acc 0.722407, Test acc 0.731055\n"
 }
]
```
